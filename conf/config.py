...
CENTRAL_WALLET = 'LWUBcsNYaz4X5F3T96VJCE7zL3nh2eWNcT' 
               # Local coin address where money goes

COINDAEMON_TRUSTED_HOST = 'localhost'
COINDAEMON_TRUSTED_PORT = 9209 
COINDAEMON_TRUSTED_USER = 'anyuser'
COINDAEMON_TRUSTED_PASSWORD = 'pwd'
...
STRATUM_MINING_PROCESS_NAME= 'twistd-stratum-mining-icoin'
...
PASSWORD_SALT = 'some_crazy_stradasfasfasfsaing'
...
DB_MYSQL_DBNAME = 'icoin'
DB_MYSQL_USER = 'root'
DB_MYSQL_PASS = 'neousb'
